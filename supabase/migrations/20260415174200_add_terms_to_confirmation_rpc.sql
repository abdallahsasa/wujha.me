-- Update get_tickets_for_confirmation to include event_terms_ar
...
BEGIN
  ...
  SELECT t.id, t.guest_name, t.guest_phone, t.qr_code, t.ticket_code,
         ...
         e.title_ar, e.slug, e.event_code, e.start_date, e.end_date, e.doors_open, e.cover_image, e.terms_ar,
